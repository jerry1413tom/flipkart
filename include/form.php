<section class="bg-white">
			<div class="mt-4">
				<div class="p-4">
					<h6 class="py-3">Top Stories:Brand Directory</h6>
					<p class="m-0" style="font-size:14px;">MOST SEARCHED FOR ON FLIPKART:<small> MOST SEARCHED FOR ON FLIPKATRT:OPP A16KVIVO |Y33TOPPO RENO | 5GiPHONE | 13iPHONE | 13proi PHONE | 13MAXIPRO | 13 MINI FLIPKART | QUICKOPPO A16KVivo Y33TOPPO Reno7 5GOPPO Reno7 Pro 5GiPhone 13iPhone 13 ProiPhone 13 Pro MaxiPhone 13 MiniFlipkart QuickBooksFlipkart Help CentreFlipkart Track OrdersFlipkart Manage OrdersFlipkart Return OrdersFlipkart Gift Cards StoreFlipkart Axis Bank Credit CardFlipkart Pay Later<br>
					...
					LAPTOPS:Microsoft Surface Go Pentium Gold 64GBMicrosoft Surface Go Pentium 128GBBranded LaptopsApple LaptopsAcer LaptopsLenovo LaptopsDell LaptopsAsus LaptopsHP LaptopsGaming Laptops2 in 1 LaptopsBusiness Laptops<br>
					...
					ooktopsInverters / stabilizerIrons / Iron BoxMixer Grinder JuicerWet GrindersChimneysMicrowave OvensVacuum CleanersWater PurifierFan<br>
					...
					BEST SELLING ON FLIPKART:BagsSamsung Galaxy Tab S7+BooksToysCandlesHelmetsWall ClocksBaby<br> FoodChocolatesCyclesCalculatorsLipsticksMaskFastrack WatchesWalletsEarringsGold CoinsHandbags<br>
			...
			<div class="px-4 mt-3">
				<h6 class="text-secondary">Flipkart: tHE one-stop shopping Destination</h6>
					...
					<h6 class="text-secondary">Flipkart plus</h6>
					...
					<h6 class="text-secondary">NO COST EMI</h6>
					<p class="mb-2" style=" font-size:10px;">
					...
					<h6 class="text-secondary">EMI on Debit Cards</h6>
					<p class="mb-2" style=" font-size:10px;">
					...
					<h6 class="text-secondary">Mobile Exchange Offers</h6>
					<p class="mb-2" style=" font-size:10px;">
					...
					<h6 class="text-secondary">What Can You Buy From Flipkart?<br>
						Mobile Phones</h6>
					<p class="mb-2" style=" font-size:10px;">
					...
					<h6 class="text-secondary">Electronic Devices and Accessories</h6>
					<p class="mb-2" style=" font-size:10px;">
					...
					<h6 class="text-secondary">Large Appliances</h6>
					<p class="mb-2" style=" font-size:10px;">
					...
					<h6 class="text-secondary">Small Home Appliances</h6>
					<p class="mb-2" style=" font-size:10px;">
					...
					<h6 class="text-secondary">Lifestyle</h6>
					<p class="mb-2" style=" font-size:10px;">
					...
					<h6 class="text-secondary">Home and Furniture</h6>
					<p class="mb-2" style=" font-size:10px;">
					...
					<h6 class="text-secondary">Baby and Kids</h6>
					<p class="mb-2" style=" font-size:10px;">
					...
					<h6 class="text-secondary">Books, Sports and Games</h6>
					<p class="mb-2" style=" font-size:10px;">
					...
					<h6 class="text-secondary">Grocery/Supermart</h6>
					<p class="mb-2" style=" font-size:10px;">
